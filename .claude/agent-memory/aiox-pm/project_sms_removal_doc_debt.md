...
description: Decisão 10.4 (sem SMS/Zenvia no MVP) já reconciliada no PRD e na ARQUITETURA; resta o Architecture Document (03-data-models, 05-security) e o código do app
metadata:
  type: project
---
...
**Já reconciliado (2026-07-30):** `docs/prd/epics/2-auth-cliente.md` (Stories 2.4 e 2.5 removidas, sem renumerar), `docs/prd/epics/3-lojista-aprovacao.md` (nenhuma story removida — só ACs), `docs/prd/epics/0-casca-visual.md`, `docs/prd/epics/9-publicacao-compliance.md`, `docs/prd/02-requirements.md` (FR2 removido), `03-ux-design.md`, `04-technical.md`, `05-epics.md`, `docs/ARQUITETURA.md`, `docs/APRESENTACAO_STAKEHOLDER.md`.

**Dívida remanescente (ainda afirma que existe SMS):** `docs/architecture/03-data-models.md` (coluna `telefone_confirmado` + tabela de códigos SMS), `docs/architecture/05-security.md` (`ZENVIA_API_TOKEN`, rate limit de SMS, item de checklist), `docs/prd/06-next-steps.md` (Zenvia no diagrama de contexto), `docs/EPICO_0_RECONCILIACAO.md` (lista a 10.4 como pendência aberta), e o código (`apps/cliente/.../ConfirmacaoSMS.tsx` + rota no `AuthStack`, `packages/core-data/src/ports/auth.port.ts` e mocks).
